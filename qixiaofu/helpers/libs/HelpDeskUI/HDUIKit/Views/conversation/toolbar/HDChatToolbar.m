...
- (void)_setupSubviews
{
    ...
    //input textview
    _inputTextView = [[HDTextView alloc] initWithFrame:CGRectMake(self.horizontalPadding, self.verticalPadding*2, self.frame.size.width - self.verticalPadding * 2, self.frame.size.height - self.verticalPadding * 2 - 10)];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/chatBar_faceSelected"] forState:UIControlStateSelected];
