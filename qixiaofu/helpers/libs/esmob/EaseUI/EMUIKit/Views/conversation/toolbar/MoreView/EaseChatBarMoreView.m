...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    _photoLabel = [[UILabel alloc] initWithFrame:CGRectMake(insets, 10 + CHAT_BUTTON_SIZE, 50 , 20)];
    ...
    _locationLabel = [[UILabel alloc] initWithFrame:CGRectMake(insets * 2 + CHAT_BUTTON_SIZE, 10 + CHAT_BUTTON_SIZE, 50 , 20)];
    ...
    _takeLabel = [[UILabel alloc] initWithFrame:CGRectMake(insets * 3 + CHAT_BUTTON_SIZE * 2, 10 + CHAT_BUTTON_SIZE, 50 , 20)];
...
//
//        _phoneLabel = [[UILabel alloc] initWithFrame:CGRectMake(insets * 4 + CHAT_BUTTON_SIZE * 3, 10+CHAT_BUTTON_SIZE , 50 , 20)];
//        _phoneLabel.text = NSLocalizedString(@"attach_picture", @"Picture");
//        _phoneLabel.font = [UIFont systemFontOfSize:10];
//        _phoneLabel.textAlignment = UITextAlignmentCenter;
...
//
//
//        _videoCallLabel = [[UILabel alloc] initWithFrame:CGRectMake(insets, 10 * 2 + CHAT_BUTTON_SIZE*2 + 10, 50 , 20)];
