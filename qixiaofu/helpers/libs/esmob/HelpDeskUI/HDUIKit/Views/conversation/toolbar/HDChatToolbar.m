...
- (void)_setupSubviews
{
    ...
    //input textview
    _inputTextView = [[HDTextView alloc] initWithFrame:CGRectMake(self.horizontalPadding, self.verticalPadding*2, self.frame.size.width - self.verticalPadding * 2 - 10, self.frame.size.height - self.verticalPadding * 2 - 10)];
    ...
    _inputTextView.backgroundColor = [UIColor colorWithWhite:0.9f alpha:1.0f];
...
//    [styleChangeButton setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/hd_record_menu_mic_gray"] forState:UIControlStateNormal];
...
//    [self setInputViewLeftItems:@[styleItem]];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/chatBar_face"] forState:UIControlStateNormal];
//    [self.faceButton setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/chatBar_faceSelected"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/chatBar_keyboardSelected"] forState:UIControlStateSelected];
