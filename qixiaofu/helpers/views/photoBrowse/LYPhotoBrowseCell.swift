...
class LYPhotoBrowseCell: UICollectionViewCell {
    ...
    var longPressBlock : LYPhotoBrowseCellBlock?
    ...
    override func awakeFromNib() {
        ...
        let longPress = UILongPressGestureRecognizer.init(target: self, action: #selector(LYPhotoBrowseCell.longPressTapAction(sender:)))
        self.imgV.addGestureRecognizer(longPress)
        self.deleteBtn.isHidden = true
    }
    
    
    @objc func longPressTapAction(sender: UILongPressGestureRecognizer) {
